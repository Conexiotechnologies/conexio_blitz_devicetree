...
LOG_MODULE_REGISTER(blitz_board_init);
...
BUILD_ASSERT(CONFIG_BLITZ_INIT_PRIORITY > CONFIG_REGULATOR_FIXED_INIT_PRIORITY,
	"CONFIG_BLITZ_INIT_PRIORITY must be higher than CONFIG_REGULATOR_FIXED_INIT_PRIORITY");
#endif /* CONFIG_REGULATOR_FIXED */
#if defined(CONFIG_IEEE802154_NRF5)
BUILD_ASSERT(CONFIG_BLITZ_INIT_PRIORITY < CONFIG_IEEE802154_NRF5_INIT_PRIO,
	"CONFIG_BLITZ_INIT_PRIORITY must be less than CONFIG_IEEE802154_NRF5_INIT_PRIO");
#endif /* CONFIG_IEEE802154_NRF5 */
#endif /* !CONFIG_TRUSTED_EXECUTION_SECURE */

#if defined(CONFIG_SENSOR)
BUILD_ASSERT(CONFIG_BLITZ_INIT_PRIORITY < CONFIG_SENSOR_INIT_PRIORITY,
	"CONFIG_BLITZ_INIT_PRIORITY must be less than CONFIG_SENSOR_INIT_PRIORITY");
#endif
...
SYS_INIT(setup, POST_KERNEL, CONFIG_BLITZ_INIT_PRIORITY);
